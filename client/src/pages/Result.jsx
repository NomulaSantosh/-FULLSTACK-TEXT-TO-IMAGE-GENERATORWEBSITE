...
const Result = () => {
  ...
  //this func will be executed whenever we will submit the form where we will
  // add the proompt in the input field and click on the submit button
  const onSubmitHandler = async (e) =>{
    // it disable the page reloading whenever we will submit
    e.preventDefault()
    setLoading(true)
