...
const Home = () => {
  ...
  return ( 
    ...
    viewport={{ once: true}}
    >{/*By default, flex arranges items in a row (flex-row by default). flex-col makes them stack vertically. */}
      ...
      <motion.h1 className='text-4xl max-width-[300px] sm:text-7xl sm:max-w-[590px]
      ...
      >
        ...
        {/*Array(6).fill('') → Creates an Array with 6 Empty Strings
     Array(6) creates an array with 6 undefined values.
